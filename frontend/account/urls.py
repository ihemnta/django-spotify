...
urlpatterns = [
    ...
    path('update/password', views.update_pass, name='frontend.account.update.pass'),
    path('privacy/', views.privacy, name='frontend.privacy'),
    path('subscription/', views.subscription, name='frontend.subscription'),
    path('update/profile-pic', views.change_profile_pic, name='frontend.account.pic.upload'),
]